...
REM
REM Generated by Vivado on Tue Feb 06 12:57:04 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj RegistersTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj RegistersTB_vlog.prj -log xvlog.log

...
REM
REM Generated by Vivado on Wed Dec 13 12:32:11 -0500 2023
...
echo "xvlog --incr --relax -L uvm -prj CMDprocTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj CMDprocTB_vlog.prj -log xvlog.log

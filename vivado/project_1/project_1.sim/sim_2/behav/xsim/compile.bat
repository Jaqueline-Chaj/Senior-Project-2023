...
REM
REM Generated by Vivado on Fri Oct 27 13:08:23 -0400 2023
...
echo "xvlog --incr --relax -L uvm -prj queueTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj queueTB_vlog.prj -log xvlog.log

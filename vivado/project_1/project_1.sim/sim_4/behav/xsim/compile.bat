...
REM
REM Generated by Vivado on Mon Nov 13 14:15:19 -0500 2023
...
echo "xvlog --incr --relax -L uvm -prj topleveltb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj topleveltb_vlog.prj -log xvlog.log

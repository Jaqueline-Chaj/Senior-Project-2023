...
#
# Generated by Vivado on Mon Oct 09 15:18:39 -0400 2023
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5fd0.protoinst" -log simulate.log
}

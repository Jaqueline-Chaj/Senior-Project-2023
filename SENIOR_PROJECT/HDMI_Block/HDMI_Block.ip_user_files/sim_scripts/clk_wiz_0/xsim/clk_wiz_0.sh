...
#
# Generated by Vivado on Sat Sep 16 18:58:16 -0400 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xilinx_vip -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2ca1.protoinst" -log simulate.log
}

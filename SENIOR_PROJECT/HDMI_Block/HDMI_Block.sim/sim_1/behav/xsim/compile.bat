...
REM
REM Generated by Vivado on Mon Oct 02 14:28:30 -0400 2023
...
echo "xvlog --incr --relax -L uvm -L v_hdmi_tx_v3_0_0 -prj tb_vlog.prj"
call xvlog  --incr --relax -L uvm -L v_hdmi_tx_v3_0_0 -prj tb_vlog.prj -log xvlog.log

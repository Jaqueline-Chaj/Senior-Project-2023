...
HD_PWD='H:/Users/leopole1/HDMI IP TEST/HDMI IP TEST.runs/VTC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VTC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VTC.tcl

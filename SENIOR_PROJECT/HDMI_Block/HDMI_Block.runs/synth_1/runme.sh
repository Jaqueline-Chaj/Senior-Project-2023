...
HD_PWD='H:/Users/leopole1/HDMI IP TEST/HDMI IP TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Display_gen.tcl

...
HD_PWD='H:/Users/leopole1/HDMI IP TEST/HDMI IP TEST.runs/HDMI_transmitter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_transmitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_transmitter.tcl

...
HD_PWD='H:/Users/leopole1/HDMI IP TEST/HDMI IP TEST.runs/bd_5fd0_v_hdmi_tx_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_5fd0_v_hdmi_tx_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_5fd0_v_hdmi_tx_0.tcl

...
HD_PWD='H:/Senior-Project-2023/SENIOR_PROJECT/Display_generator/Display_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_Gen_Digilent.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Display_Gen_Digilent.tcl -notrace

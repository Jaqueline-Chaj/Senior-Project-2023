...
#
# Generated by Vivado on Wed Feb 28 13:28:10 -0500 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../../SENIOR_PROJECT/New_Vram/New_Vram.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../../SENIOR_PROJECT/New_Vram/New_Vram.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../../SENIOR_PROJECT/New_Vram/New_Vram.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../../SENIOR_PROJECT/New_Vram/New_Vram.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log

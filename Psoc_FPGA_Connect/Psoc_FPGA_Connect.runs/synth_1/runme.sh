...
HD_PWD='H:/Senior-Project-2023/Psoc_FPGA_Connect/Psoc_FPGA_Connect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Host_to_Display_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Host_to_Display_top.tcl
